...
class Background(pygame.sprite.Sprite):
    ...
    def __init__(self,player,level=0):
        ...
        self.image=pygame.image.load('MetalPython-master\\images\\'+('bkgd.png','bossbkgd2.png')[level]).convert()
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,prev_player=None):
        ...
        ...
        self.__lives = 30  # Ensure lives are initialized
        if prev_player:
            self.__lives = prev_player.get_lives()
        else:
            self.__lives = pygame.sprite.Sprite.__init__(self)       
        print(f"Lives initialized: {self.__lives}")  # Debug statement
        
        #loads all animations into nested lists
        #self.__sprites=[[[[pygame.image.load('MetalPython-master\\images\\player\\'+str(orientation)+'\\'+str(weapon)+'\\'+str(animation)+'\\'+str(frame)+'.png').convert_alpha() 
        # for frame in range(len(os.listdir('MetalPython-master\\images\\player\\'+str(orientation)+'\\'+str(weapon)+'\\'+str(animation))))] for animation in range(7)] for weapon in range(2)] for orientation in range(2)]  
        self.__sprites = [
                [
                    [
                        [
                            pygame.image.load(
                                f'MetalPython-master/images/player/{orientation}/{weapon}/{animation}/{frame}.png'
                            ).convert_alpha()
                            for frame in range(len(os.listdir(f'MetalPython-master/images/player/{orientation}/{weapon}/{animation}')))
                        ]
        ...
        #sound
        self.__mg_sound=pygame.mixer.Sound(f'MetalPython-master\sounds\\mg.wav')
        self.__pistol_sound=pygame.mixer.Sound(f'MetalPython-master\sounds\\pistol.wav')
        self.__death=pygame.mixer.Sound(f'MetalPython-master\sounds\\marco.wav')       
    ...
    def update(self,*args):
        ...
        print(f"Lives before decrement: {self.__lives}")  # Debug statement
        if self.__health <= 0 and self.__animation != 6:
            self.__death.play()
            self.__animation = 6
            self.__weapon = 0
            self.__frame = 0
            print(f"Lives after decrement: {self.__lives}")  # Debug statement
            self.__lives -= 1
            if self.__lives <= 0:
                self.__dead = True
            else:
                # réinitialiser la santé et d'autres attributs nécessaires
                self.__health = 200  # ou toute autre valeur par défaut
                self.rect.midtop = (320, 0)  
        ...
        if self.__animation==6:   
            ...
            if self.__frame<len(self.__sprites[self.__orientation][self.__weapon][self.__animation])*3:
                self.image=self.__sprites[self.__orientation][self.__weapon][self.__animation][int(self.__frame/3)]
        ...
        #when alive
            ...
            #updates animation
            self.image=self.__sprites[self.__orientation][self.__weapon][self.__animation][int(self.__frame/self.__speed)].copy()
    ...
    def shoot(self):
        ...
        if not self.__weapon and self.__frame==1:
            ...
            return int(self.__frame/self.__speed)            
...
class MGBullet(pygame.sprite.Sprite):
    ...
    def __init__(self,bkgd,player,shotnum):
        ...
        self.__sprites=(pygame.image.load('MetalPython-master\\images\\bullet\\'+str(player.get_direction())+'\\1\\'+str(shotnum)+'.png').convert_alpha(),pygame.image.load('MetalPython-master\\images\\bullet\\bullet0.png').convert_alpha())
...
class PistolBullet(pygame.sprite.Sprite):
    ...
    def __init__(self,bkgd,player):
        ...
        self.__sprites=[pygame.image.load('MetalPython-master\\images\\bullet\\'+str(player.get_direction())+'\\0\\'+str(frame)+'.png').convert_alpha() for frame in range(2)]+[pygame.image.load('MetalPython-master\\images\\bullet\\bullet0.png').convert_alpha()]        
        #loads image and rect
        self.image=self.__sprites[0]
        self.rect=self.image.get_rect()
...
class Enemy(pygame.sprite.Sprite):
    ...
    [
        [
            pygame.image.load(f'MetalPython-master\images/enemy/{orientation}/{animation}/{frame}.png').convert_alpha()
            for frame in range(len(os.listdir(f'MetalPython-master\images/enemy/{orientation}/{animation}')))
        ]
    ...
    #sound
    __shoot=pygame.mixer.Sound('MetalPython-master\sounds\\enemy.wav')
    __death=[pygame.mixer.Sound('MetalPython-master\sounds\\soldier'+str(i)+'.wav') for i in range(1,6)]
    ...
    def update(self,player):
        ...
        if self.__animation==2:
            ...
            self.image=Enemy.__sprites[self.__orientation][self.__animation][int(self.__frame/3)]            
            self.rect=self.image.get_rect()
        ...
        #while alive        
            ...
            self.__prev=self.rect.midbottom           
            #updates image
            self.image=Enemy.__sprites[self.__orientation][self.__animation][int(self.__frame/self.__speed)]
            self.rect=self.image.get_rect()
            self.rect.midbottom=self.__prev            
...
class EnemyBullet(pygame.sprite.Sprite):
    ...
    def __init__(self,enemy,player):
        ...
        #loads all required sprites
        self.__sprites=[pygame.image.load('MetalPython-master\\images\\bullet\\'+str(enemy.get_direction())+'\\0\\'+str(frame)+'.png').convert_alpha() for frame in range(2)]+[pygame.image.load('MetalPython-master\\images\\bullet\\bullet1.png').convert_alpha()]
...
class Grenade(pygame.sprite.Sprite):
    ...
    __explosion=[pygame.image.load('MetalPython-master\\images\\grenade\\'+str(frame)+'.png').convert_alpha() for frame in range(21)]
    __grenade=pygame.image.load('MetalPython-master\\images\\grenade\\grenade.png').convert_alpha() 
    #sound
    __explode=pygame.mixer.Sound('MetalPython-master\\sounds\\explosion.wav')
...
class TankShell(pygame.sprite.Sprite):
    '''tank shell sprite'''
    __explosion=[pygame.image.load('MetalPython-master\\images\\grenade\\'+str(frame)+'.png').convert_alpha() for frame in range(21)]
    __shell=pygame.image.load('MetalPython-master\\images\\grenade\\shell.png').convert_alpha() 
    #sound
    __explode=pygame.mixer.Sound('MetalPython-master\\sounds\\explosion.wav')
...
class Tank(pygame.sprite.Sprite):
    ...
    def __init__(self,prev_tank=None):
        ...
        self.__sprites=[[pygame.image.load(f'MetalPython-master\\images\\tank\\'+str(animation)+'\\'+str(frame)+'.png').convert_alpha() for frame in range(len(os.listdir('MetalPython-master\\images\\tank\\'+str(animation))))] for animation in range(5)]         
        #loads mg turret image
        self.__mg=pygame.image.load(f'MetalPython-master\\images\\tank\\turret.png').convert_alpha() 
        ...
        #sound
        self.__cannon=pygame.mixer.Sound('MetalPython-master\\sounds\\cannon.wav')
        self.__mg_sound=pygame.mixer.Sound('MetalPython-master\\sounds\\mg.wav')
        self.__explode=pygame.mixer.Sound('MetalPython-master\\sounds\\explosion.wav')
    ...
    def update(self,*args):
        ...
        if self.__animation==4:               
            ...
            if self.__frame<len(self.__sprites[self.__animation])*3:
                self.image=self.__sprites[self.__animation][int(self.__frame/3)]
            else:
        ...
        #while alive
            ...
            #updates image
            self.image=self.__sprites[self.__animation][int(self.__frame/self.__speed)].copy()            
...
class TankBullet(pygame.sprite.Sprite):
    '''tank bullet sprite'''
    __sprite=pygame.image.load('MetalPython-master\\images\\bullet\\bullet3.png').convert_alpha()
...
class ScoreBoard(pygame.sprite.Sprite):
    ...
    def __init__(self,player,tank=None):
        ...
        self.__background=pygame.image.load('MetalPython-master\\images\\scoreboard.png').convert_alpha()
        self.__font=pygame.font.Font('MetalPython-master\\fonts\\Square.ttf',20)
        self.__player=player
        self.__tank=tank       
...
class Animation(pygame.sprite.Sprite):
    ...
    def __init__(self,num):
        ...
        #loads image and rect
        self.__image=pygame.image.load('MetalPython-master\\images\\'+('metal','python')[num]+'.png').convert_alpha()           
    ...
    def update(self):
        ...
        if self.__frame < 20:
            ...
            self.rect = self.image.get_rect()
            self.rect.center = self.__prev
            # Make the image 98% smaller each frame
            self.__size = [int(0.98 * x) for x in self.__size]
...
class Button(pygame.sprite.Sprite):
    '''button class'''
    #sound
    __press=pygame.mixer.Sound('MetalPython-master\\sounds\\button.wav')
    
    def __init__(self,num):
        '''initializer class with the button number'''
        pygame.sprite.Sprite.__init__(self)
        #loads font and text
        self.__font=pygame.font.Font('MetalPython-master\\fonts\\Square.ttf',30)        
...
class GameOver(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.__bkgd=pygame.image.load('MetalPython-master\\images\\gameover.jpg').convert()
...
class Boss(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        #loads image and rect
        self.__sprites=[pygame.image.load('MetalPython-master\\images\\boss\\tank'+str(i)+'.png').convert_alpha() for i in range(2)]
        self.__explosion=[pygame.image.load('MetalPython-master\\images\\tank\\4\\'+str(i)+'.png').convert_alpha() for i in range(17,42)]
...
class Laser(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        pygame.sprite.Sprite.__init__(self)
        #loads image and rect
        self.__sprites=[pygame.image.load('MetalPython-master\\images\\boss\\laser\\'+str(i)+'.png') for i in range(4)]
        self.image=self.__sprites[0]
        self.rect=self.image.get_rect()
        self.hide()
        self.__frame=0
...
class MGIcon(pygame.sprite.Sprite):
    ...
    def __init__(self):
        '''initializer method'''
        pygame.sprite.Sprite.__init__(self)
        self.image=pygame.image.load('MetalPython-master\\images\\mgicon.png')
        self.rect=self.image.get_rect()
        self.hide()
